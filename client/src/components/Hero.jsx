...
const Hero = () => {
    return (
        <div className="flex flex-col items-center justify-center pt-16 pb-32 px-4 relative z-10 text-center max-w-5xl mx-auto">
            ...
            {/* Headline */}
            <h1 className="text-5xl md:text-5xl font-extrabold text-brand-dark leading-[1.1] mb-6 tracking-tight">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                <button className="bg-brand-blue hover:bg-blue-600 text-white font-thin py-1 px-3 rounded-full text-base transition-all shadow-xl shadow-blue-500/20 hover:shadow-blue-500/40">
                    Get Started
                </button>

                <button className="group bg-transparent hover:bg-blue-600 hover:text-white text-gray-800 font-thin py-1 px-4 rounded-full text-base transition-all  border border-black/50 flex items-center gap-2">
                    ...
                    <img src="/apple.png" sizes={15} className='border-r-[1px] border-black/50 px-2 ' alt="" />
